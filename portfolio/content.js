/* ============================================================================
   ...
   It's just a list of fields. Keep the quotes "like this" around text, and the
   commas at the end of each line. Lines starting with // are notes to you and
   are ignored by the site.
   ========================================================================== */
...
window.CONTENT = {
  ...
  subtitle: "London, UK",            // the small line under your name
  ...
  // ---- Work experience -----------------------------------------------------
  // One block per role: where, what you did, and the years (right-aligned).
  work: [
  ...
  // ---- Education -----------------------------------------------------------
  education: [
    { org: "Queen Mary University of London", subject: "BSc Computer Science", years: "2021–2024" },
  ],

  // ---- Contact -------------------------------------------------------------
  // `text` is what's shown; `href` is where it links.
  contact: [
  ...
  // ---- Photographs (the carousel) ------------------------------------------
  // In display order, left to right. `file` is an image in the img/ folder;
  // `alt` is a short description (used by screen readers). Add, remove or
  // reorder lines freely — any file in img/ can be used.
  photos: [
