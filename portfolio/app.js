...
(function () {
  ...
  /* cut-title:end */
  // The href is a fragment, not /projects, and that is the whole of #71 at this
  // line. The section the word is the title of is now on this page — the panel
  // after .doorway — so sending the reader to a URL that 308s back to the page
  // they are already standing on would reload the document, discard the scroll
  // position and re-run every script, to arrive where an anchor gets in one
  // frame. /projects still redirects here for links this repo does not own; see
  // the redirects block in vercel.json.
